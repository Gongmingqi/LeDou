...
<html>
  ...
  function f1()
  {
   ...
   if(j==1){
   	...
   	window.location.href = "${pageContext.request.contextPath}/queryGameTypeAllBySize.do";
   }	
   }
  }
 </script>
  ...
  <body>
       ...
       <c:otherwise>
       		<a href ="${pageContext.request.contextPath}/queryGameTypeAllBySize.do">点击立即返回上一页</a>
       </c:otherwise>
       </c:choose>
  </body>
</html>
